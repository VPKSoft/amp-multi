...
Copy-Item "./docs/img/img_$platform/saved_queues1.png" "./docs/img"
Copy-Item "./docs/img/img_$platform/saved_queues2.png" "./docs/img"
Copy-Item "./docs/img/img_$platform/settings1.png" "./docs/img"
Copy-Item "./docs/img/img_$platform/settings2.png" "./docs/img"
Copy-Item "./docs/img/img_$platform/settings3.png" "./docs/img"
