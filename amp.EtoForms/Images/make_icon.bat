...
magick convert -transparent white music-note-svgrepo-com_modified.svg -resize 512x512 amp_512.png
magick convert -compress None amp_16.png amp_24.png amp_32.png amp_48.png amp_64.png amp_96.png amp_128.png amp_256.png amp_512.png amp.ico
del amp_16.png
del amp_24.png
del amp_32.png
del amp_48.png
